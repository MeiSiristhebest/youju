...
import type { AnalyzeResult, Risk, RiskStatus, Scenario, ScenarioType, Source } from '../../types'
    ...
    >
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <div data-ws-topbar className="relative shrink-0">
          {/* TODO: notificationCount 硬编码为 3，后续替换为 useNotificationStore 获取真实通知数量 */}
          <WorkspaceTopBar
            scenario={scenario}
        ...
        <div className="flex-1 overflow-hidden flex relative">
          {isChatActive ? (
            // 对话 tab 激活时：主区域显示 ChatPanel，隐藏分析面板
            <ChatPanel scenarioType={scenarioType} className="flex-1 min-w-0" />
          ) : (
            <>
              {sourcePanelCollapsed ? (
                <div
      ...
      <ProductTour
        ...
        isOpen={showTour}
        onClose={onTourClose}
        localStorageKey="youju_tour_completed"
      />
