...
export const DEMO_RESULTS: Record<string, any> = {
  ...
  homework: {
    scenario: {
      ...
      description: '对比作业要求与提交内容',
      keyDimensions: ['内容', '格式', '测试'],
    },
...
DEMO_RESULTS.legal_case = {
  scenario: {
    type: 'legal_dispute',
    description: '对比起诉状、合同与沟通记录中的法律纠纷事实',
    keyDimensions: ['合同条款', '工期', '工程质量', '违约金'],
  },
  meta: {
  ...
  summary: { critical: 2, warning: 3, info: 0 },
  risks: [
    {
      id: 'lc_risk_1',
      title: '口头承诺未写入合同',
...
DEMO_RESULTS.academic_research = {
  scenario: {
    ...
    description: '对比多篇学术论文的研究方法与结论',
    keyDimensions: ['研究方法', '测量方法', '关键发现'],
  },
  meta: {
...
DEMO_RESULTS.due_diligence = {
  scenario: {
    type: 'due_diligence',
    description: '对比尽调材料中的商业风险信息',
    keyDimensions: ['财务真实性', '关联交易', '知识产权', '团队稳定性'],
  },
  meta: {
  ...
  summary: { critical: 3, warning: 2, info: 0 },
  risks: [
    {
      id: 'dd_risk_1',
      title: '营收数据真实性存疑',
...
DEMO_RESULTS.fact_check = {
  scenario: {
    type: 'fact_check',
    description: '对比多来源事实核查信息',
    keyDimensions: ['事实核查', '裁员规模', '补偿方案'],
  },
  meta: {
